...
rt_err_t drv_spi_init(void)
{
    ...
    /* register SPI1 bus */
    ret |= stm32_spi_register(SPI3, &stm32_spi3, "spi3");
    ...
    /* attach spi_device_1 to spi1 */
    {
        ...
        stm32_spi_cs_3.GPIOx = GPIOB;
        stm32_spi_cs_3.GPIO_Pin = GPIO_Pin_3;
        ...
        ret |= rt_spi_bus_attach_device(&rt_spi_device_3, "spi3_dev1", "spi3", (void*)&stm32_spi_cs_3);
    }
